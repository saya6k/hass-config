...
This is my Home Assistant documentation version 2024-07-06

Description | Value
-- | --
Core | 2024.7.1

I have used Home Assistant in 2018 and then migrated to Apple Home.
I started to use Home Assistant again in 2022. Now it's growing bigger, 1517 total.
...
After new sections dashboard released, I moved my config from yaml to UI. My `ui-lovelace.yaml` is generated by Readme custom component. Now I use sections view as my primary and only dashboard.

I won't recommend giving too much effort on dashboard from now on, since I believe voice control with llm is superior than dashboard. 

Invest your precious time only for overview visualization.
...
<table>
  <tr>
    ...
    <td>
      <img alt="Home Assistant Yellow" src="docs/images/ha-yellow.jpg"><br>
...
-- | -- | --
Topton i5-1340p mini pc | [Generic x86-64](https://www.home-assistant.io/installation/generic-x86-64/) | I've been waiting for their next hardware that is powerful than RPi5, at least N100. Before then, I'll use this as my Home Assistant server.
Beelink EQ12 mini pc | [Frigate Home Assistant Integration](https://github.com/blakeblackshear/frigate-hass-integration) | This is my Frigate NVR server.
AppleTV 4K 3rd | [Thread](https://www.home-assistant.io/integrations/thread/) | Apple TV 4K 3rd is my primary Thread Border Router. Home Assistant Yellow also serve as back-up border router.
SONOFF ZBDongle-E | [Zigbee Home Automation](https://www.home-assistant.io/integrations/zha) | There is a irreplaceable Zigbee device so I still have this Dongle.
...
Amazon Fire 10 HD(2019) | [Fully Kiosk Browser](https://www.home-assistant.io/integrations/fully_kiosk/) | My 10-inch main Kiosk in Kitchen since 2024-7-1.
...
Vornado 630B | - | It's not smart at all, but it does what it supposed to do; Ventilation.
Xiaomi Dehumidifier 22L | [Xiaomi Miot For HomeAssistant](https://github.com/al-one/hass-xiaomi-miot) | Necessary for Korean climate.
Xiaomi Mi Air Pro | [Xiaomi Miot For HomeAssistant](https://github.com/al-one/hass-xiaomi-miot) |
Samsung Cube Air Purifier | [smartthings_customize](https://github.com/oukene/smartthings_customize) | This is only Samsung device that I use now, since my parents give me as a gift.
...
[Auxmer LED CCT Strip](https://ko.aliexpress.com/item/1005005645881199.html) | - | 38.4W/m(240 LEDs). It's very preferrable, but it's 4 times more expensive than the one below. I use this strip only for main lights.
COXO LED CCT Strip | - | 14W/m(608 LEDs) I think Auxmer one is better, but they differ in price. It's good for ambient lights, though.
[Side View LED CCT Strip](https://ko.aliexpress.com/item/1005006125013127.html) | - | To enlighten my dressing table.

# Wall Switches
I disabled all the wall switches. I only use light control with companion app or voice. I may use scene controller someday.
...
Device | HomeAssistant | Notes
-- | -- | --
Neo Coolcam Zigbee 3.0 Plug | [Zigbee Home Automation](https://www.home-assistant.io/integrations/zha) | It's connected over both Z2M or ZHA. Super stable and can monitor power usage. Up to 16A. Very cheap, slim profile, less than $10 in Aliexpress. Recommend this if you use Zigbee.
...
# Voice Control
I want to use local voice control with local LLM. I'm planning to buy Nvidia Jetson AGX Thor when it's released. Until then, I'll use [OpenAI Conversation](https://www.home-assistant.io/integrations/openai_conversation/) with GPT-4o. GPT-4o is the only viable option for now, especially for non-English conversation.

Device | HomeAssistant | Notes
-- | -- | --
[Wyoming Satellite](https://github.com/rhasspy/wyoming-satellite) | [Wyoming](https://www.home-assistant.io/integrations/wyoming/) | Generally more acceptable performance than ESP32-S3 based models. But not in aesthetics. I'm waiting for official voice hardware. I'm mainly using Jabra410 with [CY95's wonderful work.](https://www.printables.com/model/917113-home-assistant-wyoming-satellite-with-jabra410-and)

# Security
I'm now using Frigate add-on, with Google Coral TPU for object detection. It can handle more than 10 FHD streams, detect motion and recognize objects.
...
# Media
I use Spotify as my music stream. But I'm now planning to migrate to Apple Music.

Device | HomeAssistant | Notes
-- | -- | --
[AppleTV 4K 3rd](https://www.apple.com/lae/apple-tv-4k/) | [Apple TV](https://www.home-assistant.io/integrations/apple_tv) | I use 3rd version as my default Media station.
...
## Network Devices
I use Ubiquiti gear. They are definitely not enterprise grade devices, but they do their job in Homelab. It's pretty btw.
...
ITOP 03 | - | It's just a chinese clone of Varia VS3 grinder.

## Other Devices
Device | HomeAssistant | Notes
-- | -- | --
Xiaomi Robot Vacuum Cleaner 1st Generation | [Xiaomi Miot For HomeAssistant](https://github.com/al-one/hass-xiaomi-miot) | I might use other vacuum that support Matter over Thread.
...
[<img src="https://brands.home-assistant.io/_/ui_lovelace_minimalist/icon.png" height="24"/>](https://brands.home-assistant.io/_/ui_lovelace_minimalist/dark_icon.png#gh-dark-mode-only)[<img src="https://brands.home-assistant.io/_/ui_lovelace_minimalist/icon.png" height="24"/>](https://brands.home-assistant.io/_/ui_lovelace_minimalist/icon.png#gh-light-mode-only) [Ui Lovelace Minimalist](https://github.com/UI-Lovelace-Minimalist/UI) | UI-Lovelace-Minimalist is a "theme" for HomeAssistant
...
I use Home Assistant as my main Home server, so there are lots of add-ons.
I can make Home Assistant as VM and rather use dedicated VM server, but I want to keep things simple.
...
[Bootstrap Grid Card](https://github.com/ownbee/bootstrap-grid-card) | Bootstrap grid in Lovelace UI
...
[Circular Timer Card](https://github.com/karlis-vagalis/circular-timer-card) | Custom Home Assistant card to display timer countdowns using D3.js
...
[Home Assistant Swipe Navigation](https://github.com/zanna-37/hass-swipe-navigation) | ↔️ Swipe through Home Assistant Dashboard views on mobile.
...
[Lovelace Grocy Chores Card (Packaged)](https://github.com/karwosts/lovelace-grocy-chores-card) | A card to track chores and tasks in Grocy.
...
Sonos Era 100 | [Sonos](https://www.home-assistant.io/integrations/sonos/) | I once used Sonos for my main media player, but end up selling these to flee market. But they are good devices.
